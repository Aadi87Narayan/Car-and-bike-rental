...
export function CarViewer3D({ car, selectedColor, onColorChange }) {
  ...
  return (
    <div className="car-viewer-3d-wrapper">
      <div className="viewer-canvas-box">
        ...
        {/* ==========================================
            🎛️ TOP HUD & HOTSPOT DETAIL CARD
           ========================================== */}
        <div className="viewer-top-hud">
          <div className="viewer-brand-tag">
            <span className="studio-live-dot" />
            <span>3D Interactive Studio • 360° Drag & Zoom</span>
          </div>
          ...
          <div className="hotspot-detail-card animate-fade-in">
            ...
            {activeHotspot === 'engine' && (
              <>
                ...
                <p className="hotspot-desc">High-revving TwinPower Turbo unit with variable valve timing and forged internals.</p>
            ...
            {activeHotspot === 'brakes' && (
              <>
                ...
                <p className="hotspot-desc">Cross-drilled ventilated ceramic discs with 6-piston monobloc calipers for zero fade.</p>
                <div className="hotspot-stat-row">
            ...
            {activeHotspot === 'aero' && (
              <>
                <div className="hotspot-title"><Activity size={16} className="text-accent" /> Active Carbon Aerodynamics</div>
